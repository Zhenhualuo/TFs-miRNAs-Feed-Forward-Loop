...
#random permutation
    ...
    gene_list=open(G,'r').read().split('\r') #diease genes
    ...
    while q<sims:
        print '> ', q+1, 'results:'
        gene_random=random.sample(gene_list, m) #change N to number of genes, randomly select genes from human coding genes
